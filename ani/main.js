...
function Sprite(source, originX, originY, frameWidth, frameHeight, numberOfFrames, timePerFrame, scale, flip) {
    ...
    this.len = numberOfFrames; //Number of frames in this sprite (to let user pick certain frames from a sheet containing multiple animations)
...
Sprite.prototype.drawFrame = function(tick, ctx, x, y) {
...
function Slippy(game, spritesheet)  {
    this.x = 200;
    this.y = 700;
...
Slippy.prototype.draw = function()  {
...
Slippy.prototype.update = function()    {
};

function Nuke(game, spritesheet)    {
    this.sprite = new Sprite(spritesheet, 0, 0, 320, 232, 25, 0.02, 1, true);
    this.game = game;
    this.ctx = game.ctx;
    this.done = false;
    Entity.call(this, game, 850, -25);
};
...
function Crane(game, spritesheet)   {
...
function Plane(game, spritesheet)   {
...
AM.downloadAll(function () {
    ...
    var slippyArr = [AM.getAsset("./img/slippy_inbound.png"),
